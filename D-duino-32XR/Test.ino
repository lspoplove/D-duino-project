...
void setup() {
  ...
  delay(10);
  display.clear();
  display.drawString( 30, 0, "DSTIKE");
  display.setFont(ArialMT_Plain_10);
  display.drawString( 0, 16, "Button CENTER: RGB");
  display.drawString( 0, 32, "Button LEFT: Sound One");
  display.drawString( 0, 48, "Button RIGHT: Sound Two");
  display.display();
